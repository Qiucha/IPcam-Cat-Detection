...
## Demo
![demo image for ntfy on phone](demo_img/demo.PNG)
...
DISCON_TOPIC=[ex: asdf1234 (which should be generated by ntfy)]
# Note that I personally separate the disconnection topic with normal notification about cat to avoid panicking my parents, but this is not necessary and can be achieved with priorty!
